...
class AppGuidePage : public Page
{
public:
    AppGuidePage(DisplayAdapter &display, TextAdapter &text, HMIAdapter &hmi, RGBAdapter &rgb, IPageNavigator *navigator = nullptr)
        : Page(APP_GUIDE, display, text, hmi, rgb, navigator),
